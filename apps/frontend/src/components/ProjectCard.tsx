...
import { Card, Progress, Tag, theme, Typography } from "antd";
...
export const ProjectCard: React.FC<ProjectCardProps> = ({
    ...
    return (
        <Card
            ...
            style={cardStyle}
            extra={
                <Tag color={active ? "gold" : "green"}>
                    {active ? "Aktiv" : "Abgeschlossen"}
                </Tag>
            }
        >
            ...
            <div style={{ marginBottom: 4 }}>
                <Text strong>
                    {firstUndone ? `Phase: ${DDD_STEP_META[firstUndone].label}` : "Fertig"}
                </Text>
